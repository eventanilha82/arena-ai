...
As capturas em `docs/images/screens/` existem exclusivamente para a galeria pública do README. Elas são promovidas da evidência criada por `make visual-qa`, ficam rastreadas no Git para renderização no GitHub e não são carregadas pelo jogo.
